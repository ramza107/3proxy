 ...
 * "I'll send the deck tomorrow" → Wahrly offers a real task.
 */
export function PromisesBrief({ userId, enabled }: Props) {
  ...
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.tagline}>From your sent mail — not another inbox view.</Text>
      ...
      {loading && !data ? (
        ...
        <>
          <Text style={styles.summary}>
            Wahrly reads commitments like “I’ll send…” in emails you already wrote, then offers
            tasks. Gmail never does this.
          </Text>
